...
exports.dedupeTiptapContent = dedupeTiptapContent;
        ...
        this.server = new server_1.Hocuspocus({
                ...
                try {
                    ...
                    if (project && project.content) {
                        ...
                        if (loadDedupe.removed > 0) {
                            logger_1.default.warn(`[HP] Collapsed ${loadDedupe.removed} duplicate top-level nodes from DB content for ${projectId} before serving (repetitions: ${loadDedupe.repetitions})`);
            ...
            async onStoreDocument(data) {
                ...
                try {
                    ...
                    const extensions = self.getExtensions();
                    let content = transformer_1.TiptapTransformer.extensions(extensions).fromYdoc(document, "default");
                    ...
                    if (dedupeResult.removed > 0) {
                        logger_1.default.warn(`[HP] Removed ${dedupeResult.removed} duplicate top-level nodes before storing ${projectId}`, { projectId, repetitions: dedupeResult.repetitions });
