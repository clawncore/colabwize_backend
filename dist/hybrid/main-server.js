...
const index_3 = __importDefault(require("../api/survey/index"));
const index_4 = __importDefault(require("../api/originality/index"));
const index_5 = __importDefault(require("../api/citations/index"));
const index_6 = __importDefault(require("../api/annotations/index"));
const index_7 = __importDefault(require("../api/notifications/index"));
const index_8 = __importDefault(require("../api/team-chat/index"));
const index_9 = __importDefault(require("../api/pdf/index"));
const index_10 = __importDefault(require("../api/workspaces/index"));
const index_11 = __importDefault(require("../api/authorship/index"));
const index_12 = __importDefault(require("../api/ai-detection/index"));
const index_13 = __importDefault(require("../api/analytics/index"));
const index_14 = __importDefault(require("../api/subscription/index"));
const lemonsqueezy_1 = __importDefault(require("../api/webhooks/lemonsqueezy"));
const index_15 = __importDefault(require("../api/users/index"));
...
const index_16 = __importDefault(require("../api/editor/index"));
const route_1 = __importDefault(require("../api/recyclebin/route"));
const index_17 = __importDefault(require("../api/feedback/index"));
const index_18 = __importDefault(require("../api/support-ticket/index"));
const index_19 = __importDefault(require("../api/feature-request/index"));
const index_20 = __importDefault(require("../api/contact/index"));
const index_21 = __importDefault(require("../api/onboarding/index"));
const index_22 = __importDefault(require("../api/chat/index"));
const index_23 = __importDefault(require("../api/waitlist/index"));
const upload_1 = __importDefault(require("../api/images/upload"));
const index_24 = __importDefault(require("../api/templates/index"));
const index_25 = __importDefault(require("../api/workspace-templates/index"));
const index_26 = __importDefault(require("../api/behavioral-tracking/index"));
const index_27 = __importDefault(require("../api/proxy/index"));
const index_28 = __importDefault(require("../api/sources/index"));
const unsplash_1 = __importDefault(require("../api/integrations/unsplash"));
const index_29 = __importDefault(require("../api/search-alerts/index"));
const index_30 = __importDefault(require("../api/research/index"));
const index_31 = __importDefault(require("../audit/index"));
const subscriptionJobs_1 = require("../jobs/subscriptionJobs");
const searchAlertJobs_1 = require("../jobs/searchAlertJobs");
const index_32 = __importDefault(require("../api/admin/index"));
const index_33 = __importDefault(require("../api/blogs/index"));
// Publishing Platform (Phase 3): export job system + router
const jobs_1 = require("../publishing/jobs");
const index_34 = __importDefault(require("../api/zotero/index"));
const index_35 = __importDefault(require("../api/mendeley/index"));
const index_36 = __importDefault(require("../api/references/index"));
const collections_1 = __importDefault(require("../api/references/collections"));
const index_37 = __importDefault(require("../api/google-drive/index"));
const index_38 = __importDefault(require("../api/onedrive/index"));
...
app.use("/api/auth", rateLimiter_1.authLimiter, index_2.default);
// AI Grammar Checker API
app.use("/api/grammar", authMiddleware, index_1.default);
// Survey API (Authentication required)
app.use("/api/survey", authMiddleware, index_3.default);
app.use("/api/workspaces", index_10.default);
app.use("/api/team-chat", index_8.default);
app.use("/api/notifications", index_7.default);
app.use("/api/pdf", index_9.default);
// Originality Map API (MVP Feature #1)
app.use("/api/originality", authMiddleware, index_4.default);
// Citations API (MVP Feature #2 - Citation Confidence + Missing Link)
app.use("/api/citations", authMiddleware, index_5.default);
// Annotations API (Feature 2: PDF Annotator)
app.use("/api/annotations", authMiddleware, index_6.default);
// Authorship Certificate API (MVP Feature #4)
app.use("/api/authorship", authMiddleware, index_11.default);
// AI Detection API
app.use("/api/ai-detection", authMiddleware, index_12.default);
// Comprehensive Citation Audit Engine API
app.use("/api/audit", authMiddleware, index_31.default);
// Apply auth middleware to notification routes
app.use("/api/notifications", authMiddleware);
// Mount the notifications router
app.use("/api/notifications", index_7.default);
// Analytics API
app.use("/api/analytics", authMiddleware, index_13.default);
// Admin Platform API
app.use("/api/admin", authMiddleware, index_32.default);
// Subscription API
app.use("/api/subscription", index_14.default);
...
app.use("/api/behavioral-tracking", authMiddleware, index_26.default);
// Users API (Authentication required)
app.use("/api/users", authMiddleware, index_15.default);
...
app.use("/api/editor", authMiddleware, index_16.default);
// Feedback API (Authentication required for most routes, public endpoint available)
app.use("/api/feedback", index_17.default);
// Support Ticket API (Authentication required)
app.use("/api/support-ticket", authMiddleware, index_18.default);
// Feature Request API (Some endpoints public, others require authentication)
app.use("/api/feature-request", index_19.default);
// Contact API (Public)
app.use("/api/contact", index_20.default);
// Waitlist API (Public)
app.use("/api/waitlist", index_23.default);
// Public Blog API (No auth required - serves published posts to the website)
app.use("/api/blogs", index_33.default);
...
app.use("/api/onboarding", authMiddleware, index_21.default);
// AI Chat API (Authentication required)
app.use("/api/chat", authMiddleware, index_22.default);
// Templates API (Authentication required)
app.use("/api/templates", authMiddleware, index_24.default);
// Workspace Templates API (Authentication required)
app.use("/api/workspace-templates", authMiddleware, index_25.default);
// Proxy API (Authentication required)
app.use("/api/proxy", authMiddleware, index_27.default);
// Sources API (Authentication required - Source Integration Verification)
app.use("/api/sources", authMiddleware, index_28.default);
// Integrations API (Unsplash Proxy)
app.use("/api/integrations/unsplash", authMiddleware, unsplash_1.default);
// Search Alerts API
app.use("/api/search-alerts", authMiddleware, index_29.default);
// Research Assistant API
app.use("/api/research", authMiddleware, index_30.default);
// Apply auth middleware to notification routes
app.use("/api/notifications", authMiddleware);
app.use("/api/zotero", index_34.default);
app.use("/api/mendeley", index_35.default);
app.use("/api/references", index_36.default);
...
app.use("/api/google-drive", index_37.default);
app.use("/api/onedrive", index_38.default);
