...
async function probe() {
    console.log("FULLBOOT PID", process.pid);
    console.log("ENV_GAC_SET:", !!process.env.GOOGLE_APPLICATION_CREDENTIALS, JSON.stringify(process.env.GOOGLE_APPLICATION_CREDENTIALS || "(unset)"));
    console.log("STATUS:", JSON.stringify(googleAnalyticsService_1.gaService.getStatus()));
    try {
        ...
        console.log("FULLBOOT FAILED:", e.message);
    }
    process.exit(0);
}
probe();
