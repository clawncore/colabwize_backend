    ...
    try {
        ...
        const templates = [
            ...
            },
            {
                ...
                description: "A precise, structured template for documenting laboratory experiments, procedures, and data analysis in technical courses.",
                type: "lab-report",
            ...
            },
            {
                ...
                description: "A visually structured template for summarizing, analyzing, and assessing research sources, with automatic citation formatting and AI assistance.",
            ...
            },
            {
                ...
                description: "A minimalist, distraction-free template for writing standard argumentative essays. Includes prompts for thesis development, topic sentences, and evidence integration.",
                type: "essay",
            ...
            },
            {
                ...
                description: "A rigorously formatted template for technical papers, using the standard two-column layout, abstract, keywords block, and numerical reference style required by IEEE.",
            ...
            },
            {
                ...
                description: "A high-impact, minimalist presentation template designed for academic defenses, project pitches, or final report summaries, emphasizing visuals and key takeaways.",
            ...
            },
            {
                ...
                description: "A visually engaging template for documenting business challenges, design processes (e.g., UX/UI), and quantifying project outcomes with key metrics.",
                type: "case-study",
            ...
            },
            {
                ...
                description: "A personal and private template structured to guide users through the process of academic or personal reflection, turning an experience into a concrete action plan.",
                type: "journal-entry",
                tags: [
                    "personal",
                    "academic",
            ...
            },
            {
                ...
                description: "A visually compelling template for pitching services, products, or projects to commercial clients. Focuses on articulating the problem, detailing the solution, and presenting a clear call-to-action.",
        ...
        const existingTemplates = await prisma_1.prisma.documentTemplate.findMany({
            where: {
                name: {
        ...
        for (const template of templates) {
            if (!existingTemplateNames.has(template.name)) {
                await prisma_1.prisma.documentTemplate.create({
                    data: template,
                });
