...
async function runTest() {
    ...
    for (const test of testCases) {
        ...
        const score = await originalityMapService_1.OriginalityMapService.calculateSimilarity(test.text1, test.text2);
        ...
        if (test.description === "Exact Match" && score > 0.9) {
            ...
            console.log("✅ PASS: Semantic match detected (likely via Transformers).");
        }
