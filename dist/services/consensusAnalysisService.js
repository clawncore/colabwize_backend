...
exports.ConsensusAnalysisService = void 0;
...
class ConsensusAnalysisService {
     ...
     */
    static async analyzeStance(claim, abstract, citationId) {
        try {
...
Respond in JSON format:
{
  ...
  "journalReputation": "high" | "standard" | "low"
            ...
            logger_1.default.info("Stance analyzed", {
                citationId,
            ...
            logger_1.default.error("Failed to analyze stance", {
                citationId,
                error: error.message
            });
     ...
     */
    static async analyzeConsensus(claim, citations) {
        try {
            ...
            const convergentCount = supporting.filter(s => s.methodologyQuality === "high" &&
                s.independentVerification &&
                s.replicationStatus === "replicated").length;
            ...
            const methodologyScore = Math.round((results.filter(r => r.methodologyQuality === "high").length * 100 +
     ...
     */
    static determineConsensusLevel(agreementPercentage) {
        if (agreementPercentage >= 80)
            return "strong";
        if (agreementPercentage >= 60)
            return "emerging";
        if (agreementPercentage >= 40)
            return "divided";
     ...
     */
    static generateEnhancedSummary(supporting, opposing, neutral, total) {
     ...
     */
    static async extractConsensusTopics(projectId) {
        try {
            ...
            logger_1.default.info("Consensus topics extracted", {
                projectId,
            ...
            logger_1.default.error("Failed to extract consensus topics", {
                projectId,
                error: error.message
            });
            return [];
     ...
     */
    static async identifyTopics(citations) {
...
exports.ConsensusAnalysisService = ConsensusAnalysisService;
