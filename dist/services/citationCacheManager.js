...
exports.CitationCacheManager = void 0;
...
class CitationCacheManager {
    ...
    static bibliographyCache = new Map();
    static TTL = 1000 * 60 * 60; // 1 Hour TTL
    /**
     ...
     */
    static generateClusterKey(style, items, clusterIds) {
        ...
        return crypto_1.default.createHash('sha256').update(contentStr).digest('hex');
    }
    /**
     * Generate a key for bibliography
     */
    static generateBibKey(style, itemHashes) {
        const contentStr = JSON.stringify({
            style,
    ...
    static setBibliography(key, data) {
...
exports.CitationCacheManager = CitationCacheManager;
