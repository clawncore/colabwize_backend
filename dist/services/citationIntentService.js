...
exports.CitationIntentService = void 0;
...
class CitationIntentService {
     ...
     */
    static async classifyCitationIntent(citationId, contextText) {
        try {
            // Get API key
...
Respond in JSON format:
{
  ...
  "reasoning": "Brief explanation"
            ...
            logger_1.default.info("Citation intent classified", {
                citationId,
                intent: result.type,
     ...
     */
    static async batchClassifyIntents(citations) {
        ...
        for (let i = 0; i < citations.length; i += batchSize) {
            ...
            const promises = batch.map(c => this.classifyCitationIntent(c.id, c.context)
     ...
     */
    static getIntentStatistics(intents) {
        const stats = {
            supporting: 0,
            contrasting: 0,
            background: 0,
...
exports.CitationIntentService = CitationIntentService;
