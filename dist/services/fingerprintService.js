...
class FingerprintService {
     ...
     */
    static generateFingerprints(text, windowSize = 8) {
        ...
        logger_1.default.debug("Generated fingerprints", {
    ...
    static compareFingerprints(fp1, fp2) {
        ...
        logger_1.default.debug("Fingerprint comparison", {
     ...
     */
    static findMatchingSegments(text1, text2, windowSize = 8) {
     ...
     */
    static calculateCoverage(text1, text2) {
        ...
        logger_1.default.debug("Coverage calculation", {
