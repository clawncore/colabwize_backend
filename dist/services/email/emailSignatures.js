...
exports.ALIAS_SIGNATURES = void 0;
exports.buildEmailHeader = buildEmailHeader;
exports.buildBrandedBlock = buildBrandedBlock;
exports.buildMandatoryFooter = buildMandatoryFooter;
exports.buildEmailSignature = buildEmailSignature;
/**
 ...
 */
function buildBrandedBlock(centered = false) {
 ...
 */
function buildMandatoryFooter(recipientEmail) {
 ...
 */
function buildEmailSignature(alias, overrideName, overrideTitle) {
    const profile = { ...exports.ALIAS_SIGNATURES[alias] };
    if (!profile && !overrideName)
        return "";
    if (overrideName)
        profile.name = overrideName;
    if (overrideTitle)
        profile.title = overrideTitle;
    return `
