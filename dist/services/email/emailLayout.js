...
exports.wrapInPremiumLayout = wrapInPremiumLayout;
const emailSignatures_1 = require("./emailSignatures");
/**
 ...
 */
function buildEmailHtml({ title, content, ctaUrl, ctaText, titleColor = "#111827", recipientEmail, }) {
    ...
    <tr>
      <td align="center" style="padding: 40px 15px;">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; border: 1px solid #e2e8f0; box-shadow: 0 4px 25px rgba(0, 0, 0, 0.04); overflow: hidden;">
          <tr>
            <td style="padding: 40px;">
              <!-- Header Branding -->
              ${(0, emailSignatures_1.buildBrandedBlock)(true)}
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin-top: 20px;">
          <tr>
            <td align="center">
              ${(0, emailSignatures_1.buildMandatoryFooter)(recipientEmail)}
            </td>
          </tr>
        </table>
      </td>
 ...
 */
function wrapInPremiumLayout(content, senderAlias, senderName, senderTitle, recipientEmail) {
    const signature = (0, emailSignatures_1.buildEmailSignature)(senderAlias, senderName, senderTitle);
    const header = (0, emailSignatures_1.buildEmailHeader)();
    return `
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
