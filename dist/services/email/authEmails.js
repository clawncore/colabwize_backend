...
exports.send2FAEnabledEmail = send2FAEnabledEmail;
exports.sendProfileUpdateOTPEmail = sendProfileUpdateOTPEmail;
exports.sendAccountDeletionEmail = sendAccountDeletionEmail;
exports.sendAccountActivityAlertEmail = sendAccountActivityAlertEmail;
 ...
 */
async function send2FAEnabledEmail(to, fullName = "") {
    const frontendUrl = await secrets_service_1.SecretsService.getFrontendUrl();
    const content = `
    <p>Hello ${fullName || "there"},</p>
 ...
 */
async function sendProfileUpdateOTPEmail(to, otp, isEmailChange = false) {
 ...
 */
async function sendAccountDeletionEmail(to, fullName = "") {
    const content = `
    <p>Hello ${fullName || "there"},</p>
 ...
 */
async function sendAccountActivityAlertEmail(to, fullName = "", deviceInfo = "an unrecognized device", time = new Date().toLocaleString()) {
    const frontendUrl = await secrets_service_1.SecretsService.getFrontendUrl();
    const content = `
    <p>Hello ${fullName || "there"},</p>
