...
exports.CitationPatternObserver = void 0;
const styleRules_1 = require("./styleRules");
/**
...
class CitationPatternObserver {
     ...
     */
    static observe(text, activeStyle) {
        const flags = [];
        const rules = (0, styleRules_1.getStyleRules)(activeStyle);
    ...
    static detectMixedStyles(text) {
        ...
        while (numRegex.exec(text) !== null)
            numericCount++;
        // Check Author-Year
        const ayRegex = new RegExp(this.PATTERNS["AUTHOR_YEAR"]);
        ayRegex.lastIndex = 0;
        while (ayRegex.exec(text) !== null)
            authorYearCount++;
...
exports.CitationPatternObserver = CitationPatternObserver;
