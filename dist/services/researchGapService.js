...
exports.ResearchGapService = void 0;
...
class ResearchGapService {
     ...
     */
    static async analyzeGaps(projectId) {
        try {
...
`;
            ...
            try {
                ...
                logger_1.default.error("Failed to parse AI research gaps response", { rawResponse });
            ...
            logger_1.default.info("Research gap AI analysis completed", {
                projectId,
            ...
            logger_1.default.error("Failed to analyze research gaps with AI", {
                projectId,
                error: error.message
            });
            throw error;
...
exports.ResearchGapService = ResearchGapService;
