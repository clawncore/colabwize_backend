...
const realTimeAuthorshipTrackingService_1 = require("./realTimeAuthorshipTrackingService");
...
async function testAuthorshipTracking() {
    ...
    try {
        ...
        await realTimeAuthorshipTrackingService_1.RealTimeAuthorshipTrackingService.trackActivity({
            projectId,
            userId,
            eventType: "keystroke",
            timestamp: new Date(),
        ...
        const writingPatterns = await realTimeAuthorshipTrackingService_1.RealTimeAuthorshipTrackingService.calculateWritingPatterns(projectId, userId);
        console.log("Writing Patterns:", writingPatterns);
        console.log("\n3. Testing comprehensive authenticity report...");
        // Generate authenticity report
        const authenticityReport = await realTimeAuthorshipTrackingService_1.RealTimeAuthorshipTrackingService.generateAuthenticityReport(projectId, userId);
        ...
        const certStats = await activityTrackingService_1.ActivityTrackingService.getCertificateStats(projectId, userId);
