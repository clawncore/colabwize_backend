...
router.get("/", async (req, res) => {
    ...
    `));
        ...
        logger_1.default.error("Unsubscribe Page Error:", error);
...
router.post("/", async (req, res) => {
    try {
        ...
        if (user) {
            ...
            logger_1.default.info(`User unsubscribed from marketing: ${email}`);
        }
        res.send(PAGE_SHELL(`
      <div class="success-icon">👋</div>
    ...
    `));
        ...
        logger_1.default.error("Unsubscribe Confirm Error:", error);
...
router.post("/confirm", async (req, res) => {
    try {
        ...
        if (!alreadyUnsubscribed) {
            ...
            logger_1.default.info(`[Unsubscribe] User opted out: ${email}`);
        }
        ...
        `,
            ...
            logger_1.default.info(`[Unsubscribe] Feedback sent to support for: ${email}`);
        }
