...
exports.handleFeatureRequest = void 0;
...
const handleFeatureRequest = async (req, res) => {
    ...
    try {
        const { featureTitle, featureDescription, useCase, category, priority, email, } = req.body;
        ...
        if (!featureTitle ||
            ...
            return res.status(400).json({
                error: "Missing required fields: featureTitle, featureDescription, useCase, category, and priority are required",
            });
        }
...
exports.handleFeatureRequest = handleFeatureRequest;
exports.default = exports.handleFeatureRequest;
