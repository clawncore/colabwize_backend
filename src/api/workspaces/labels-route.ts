...
router.post("/:id/labels", checkWorkspaceRole("editor"), async (req: any, res) => {
  try {
    const { id } = req.params;
...
router.patch("/labels/:labelId", checkWorkspaceRole("editor"), async (req: any, res) => {
  try {
...
router.delete("/labels/:labelId", checkWorkspaceRole("editor"), async (req: any, res) => {
  try {
    const { labelId } = req.params;
...
router.post("/tasks/:taskId/labels/:labelId", checkWorkspaceRole("editor"), async (req: any, res) => {
  try {
...
router.delete("/tasks/:taskId/labels/:labelId", checkWorkspaceRole("editor"), async (req: any, res) => {
  try {
    const { taskId, labelId } = req.params;
