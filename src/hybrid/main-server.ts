...
import adminContactRequestsRouter from "../admin/api/contact-requests";
...
import adminMonitoringRouter from "../admin/api/monitoring";
import adminOperationsRouter from "../admin/api/operations";
import adminSystemHealthRouter from "../admin/api/system-health";
import adminSecurityRouter from "../admin/api/security";
import adminPlatformRouter from "../admin/api/platform";
import adminRemoteRouter from "../admin/api/remote";
